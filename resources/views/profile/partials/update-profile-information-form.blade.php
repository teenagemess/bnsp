<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="alamat" :value="__('Nomor Telepon')" />
            <x-text-input id="no_hp" name="no_hp" type="number" class="block w-full mt-1" :value="old('no_hp', $user->no_hp)" required autofocus autocomplete="name" />
            <x-input-error class="mt-2" :messages="$errors->get('no_hp')" />
        </div>

        <div>
            <x-input-label for="no_hp" :value="__('Alamat')" />
            <x-text-input id="alamat" name="alamat" type="text" class="block w-full mt-1" :value="old('alamat', $user->alamat)" required autofocus autocomplete="name" />
