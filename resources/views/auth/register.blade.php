<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="alamat" class="block w-full mt-1" type="text" name="alamat" :value="old('alamat')" required autocomplete="alamat" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="no_hp" class="block w-full mt-1" type="number" name="no_hp" :value="old('no_hp')" required autocomplete="no_hp" />
            <x-input-error :messages="$errors->get('no_hp')" class="mt-2" />
        </div>
